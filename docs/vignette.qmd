...
> *[Screenshot: Multilingual checked, Open weights and Open training data checked; grid showing BLOOM 176B, Falcon 7B, Falcon 40B with license column visible]*
...
> *[Screenshot: all five openness checkboxes checked; three results in the grid; OLMo 7B profile card open showing Recent arXiv papers expander]*
